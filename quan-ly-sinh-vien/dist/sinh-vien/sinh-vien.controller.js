...
let SinhVienController = class SinhVienController {
    ...
    findAll(page = '1', limit = '10', search, tutorId, subjectId) {
...
__decorate([
    ...
    __param(3, (0, common_1.Query)('tutorId')),
...
__decorate([
    (0, common_1.Post)(),
    (0, roles_decorator_1.Roles)(role_enum_1.Role.ADMIN, role_enum_1.Role.GIAOVU),
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], SinhVienController.prototype, "remove", null);
