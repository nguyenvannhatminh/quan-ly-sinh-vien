...
let SubjectService = class SubjectService {
    ...
    findOne(id) {
        return this.subjectRepository.findOne({ where: { SubID: id } });
    }
    update(id, updateSubjectDto) {
        return this.subjectRepository.update({ SubID: id }, updateSubjectDto);
    }
    remove(id) {
        return this.subjectRepository.delete({ SubID: id });
    }
};
