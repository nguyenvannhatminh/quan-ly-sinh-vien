...
var SubjectController = /** @class */ (function () {
    ...
    SubjectController.prototype.layDanhSach = function () {
        return this.subjectService.layDanhSach();
    };
    SubjectController.prototype.layChiTiet = function (id) {
        return this.subjectService.layChiTiet(id);
    };
    SubjectController.prototype.themMoi = function (duLieuMoi) {
        return this.subjectService.themMoi(duLieuMoi);
    };
    SubjectController.prototype.capNhat = function (id, duLieuCapNhat) {
        return this.subjectService.capNhat(id, duLieuCapNhat);
    };
    SubjectController.prototype.xoa = function (id) {
    ...
    ], SubjectController.prototype, "layDanhSach", null);
    __decorate([
        (0, common_1.Get)(':id'),
        ...
        __metadata("design:returntype", void 0)
    ], SubjectController.prototype, "layChiTiet", null);
    __decorate([
        (0, common_1.Post)(),
        ...
        __metadata("design:returntype", void 0)
    ], SubjectController.prototype, "themMoi", null);
    __decorate([
        (0, common_1.Put)(':id'),
        __param(0, (0, common_1.Param)('id')),
        ...
        __metadata("design:returntype", void 0)
    ], SubjectController.prototype, "capNhat", null);
    __decorate([
        ...
        __metadata("design:paramtypes", [String]),
        __metadata("design:returntype", void 0)
    ], SubjectController.prototype, "xoa", null);
